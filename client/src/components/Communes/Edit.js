...
class AddCommune extends Component {
  ...
  submit = e => {
    const { commune, ville, nom, images, frontieres, attributs } = this.state;
    let details = [], errors = [];
  ...
  render() {
    const { villes, commune, nom, code_postal, frontieres, communeImages } = this.state;
    return (
